...
{
    public partial class FR_GestionLlamada : Form
    {
        S_Ceriv _ceriv = new S_Ceriv();
        public FR_GestionLlamada()
        {
            InitializeComponent();
            Atajo();
            CargarDataGridView();
        ...
        public void CargarDataGridView()
        {
            ...
            dgv_Reporte.DataSource = _ceriv.ReporteMensualLlamada();
        }
        public void CargarDataGridViewCuentaBT(string codigo)
        {
            dgv_Reporte.DataSource = null;
            dgv_Reporte.AutoGenerateColumns = false;
            dgv_Reporte.DataSource = _ceriv.ReporteMensualLlamadaCuentaBT(codigo);
        }
